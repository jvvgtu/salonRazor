...
namespace SalonWithRazor.Migrations
{
    ...
    [Migration("20200506110938_AddedCreatedTimesToAppealAndNotiflication")]
    partial class AddedCreatedTimesToAppealAndNotiflication
    {
            ...
            modelBuilder.Entity("SalonWithRazor.Models.Notification", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Notifications_Type_Enum_Constraint", "[Type] IN(0, 1)");
                });
