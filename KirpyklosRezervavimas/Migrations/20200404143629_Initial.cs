        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailPromotion = table.Column<bool>(nullable: true),
                    NationalId = table.Column<decimal>(type: "decimal(11, 0)", nullable: true),
                    BirthDate = table.Column<DateTime>(type: "date", nullable: true),
                    Address = table.Column<string>(nullable: true),
                    JobTitleId = table.Column<int>(nullable: true),
                    SalonId = table.Column<int>(nullable: true),
                    EmployeePictureId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(nullable: true),
                    EstimatedTime = table.Column<byte>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceJobTitles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceJobTitles_JobTitles_JobTitleId",
                        column: x => x.JobTitleId,
                        principalTable: "JobTitles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceJobTitles_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservationComments_Reservations_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationComments_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceJobTitles_JobTitleId",
                table: "ServiceJobTitles",
                column: "JobTitleId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceJobTitles_ServiceId",
                table: "ServiceJobTitles",
                column: "ServiceId");
