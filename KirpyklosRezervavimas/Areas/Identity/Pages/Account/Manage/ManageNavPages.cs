...
namespace SalonWithRazor.Areas.Identity.Pages.Account.Manage
{
    public static class ManageNavPages
    {
        ...
        public static string EmployeeAppealToSalon => "EmployeeAppealToSalon";
        ...
        public static string EmployeeAppealToSalonNavClass(ViewContext viewContext) => PageNavClass(viewContext, EmployeeAppealToSalon);
